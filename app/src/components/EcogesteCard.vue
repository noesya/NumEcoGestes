<script>
  export default {
    props: ['ecogesteKey', 'ecogeste', 'buttons'],
...
<template>
  <div class="fr-card fr-card--horizontal fr-card--horizontal-half" v-if="ecogeste">
      ...
      <div class="fr-card__content">
        ...
        <div class="fr-card__end" v-if="showButtons">
          <ul class="fr-btns-group fr-btns-group--inline-md">
            <li><button class="fr-btn">Je le fais !</button></li>
